...
const TOOLS = [
  {
    ...
    description: "Generate personalised client presentation PDFs with layout plans, renders, and contact details.",
    icon: (
  ...
  },
  {
    key: "xlsx",
    label: "SO Generator",
    description: "Upload a pricing quotation XLSX and instantly convert it into a formatted sales order file.",
    icon: (
      <svg width="32" height="32" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
...
export default function HomePage({ onNavigate }) {
  return (
    <div style={{
      ...
      padding: '96px 24px 48px',   // 96px top = navbar clearance
